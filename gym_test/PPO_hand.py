...
def main():
    ...
    avg_length = 0
    time_step = 0
    # with open("reward_each_episode.csv") as csvfile:
    ...
    for i_episode in range(1, max_episodes+1):
        ...
        avg_length += t
        # with open("reward_each_episode.csv","a+",newline="") as csvfile:
        #     writer = csv.writer(csvfile)
        #     epo=int(current_episode)+i_episode
        #     writer.writerow([running_reward,epo])
        # stop training if avg_reward > solved_reward
        if running_reward > (log_interval*solved_reward):
            print("########## Solved! ##########")
            torch.save(ppo.policy.state_dict(), './PPO_hand_solved_{}_{}.pth'.format(i_episode,lr))
            break
        
        # save every 500 episodes
        if i_episode % 500== 0:
            torch.save(ppo.policy.state_dict(), './PPO_hand_lr=0.02_episode{}_{}.pth'.format(i_episode,lr))
